...
import PolishedBidderDocumentModel from './PolishedBidderDocumentModel';
...
import { DocumentListDialogProps } from 'types/dialog';
...
const PolishedBiddersDocumentListDialog = ({ open, handleClose, entityID, co_name }: DocumentListDialogProps) => {
  ...
  return loading.isLoading && !loading.isProgress ? (
    ...
    <>
            ...
            <MainCard content={false} title="Manage Legal Document">
              <TableContainer>
                <Table sx={{ minWidth: 750 }} aria-labelledby="tableTitle" size="small">
                  <DocumentTableHeader {...{ order, orderBy, onRequestSort: handleRequestSort, companyNameSearch: co_name }} />
                  <DocumentTableBody
                    {...{
                      data,
                      page,
      ...
      <AlertDeletetPopup
        ...
        title="Are you sure want to delete this delete document?"
        loading={loading}
      />
      <PolishedBidderDocumentModel
...
export default PolishedBiddersDocumentListDialog;
