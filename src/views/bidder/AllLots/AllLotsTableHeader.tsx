...
const headPolishedCells: HeadCell[] = [
  ...
  { id: 'SalesType', numeric: false, disablePadding: false, label: 'Type of Sale', sortable: true, minWidth: 110 },
...
export default AllLotsTableHeader;
